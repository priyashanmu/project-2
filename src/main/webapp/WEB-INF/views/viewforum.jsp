      ...
      <div class="row">
        <div class="col-md-6 col-md-offset-3">
						...
						<h1 style="color:red;">${f.question}</h1>
									...
									<form:form commandName="rg" action="./addReplay?id=${f.fid}" method="post">
									<form:hidden path="forumid" value="${f.fid}"/>
									<h1 class="text-info"><center>Share Your Answers</center></h1><br>
	
									 <form:textarea path="replay" placeholder="answer" class="form-control"/><br><br>
									 <form:input path="uname" placeholder="UserName" class="form-control"/><br>
									<center> <input type="submit" class="btn btn-primary" value="Replay"></center> <br>
									 </form:form>
            ...
            <div class="panel panel-info">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        <span class="glyphicon glyphicon-list-alt"></span>  Recent Answers
                    </h3>
                </div>
                        ...
                        <li class="media">
                            <div class="media-body">
                                <h4 class="media-heading">
                                                <c:forEach items="${rmts}" var="rmt">
	<h2 style="color:blue;"> ${rmt.uname} </h2>
                                            </h4>
                                <p class="margin-top-10 margin-bottom-20">
                                    <h3 style="color:black;">${rmt.replay}</h3>
								   </p>
                            </c:forEach>
                            </div>
                        </li>
